...
public class ChanaMasala extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ing = "1.3 Tbsp grape seed oil (or sub coconut oil)\n\n" +
        ...
        String prepare = "1.Heat a large pot over medium heat. Once hot, add oil, onion, cumin, and one-third of the salt (1/4 tsp as original recipe is written  adjust if altering batch size).\n\n\n" +
